        ...
        <div className="compose-content">
          ...
          <div className="posts-container">
            {loading ? (
              ...
              <div className="post">
                <div className="post-content">
                  <div className="post-text" style={{color: 'var(--accent-red)'}}>{error}</div>
                </div>
              </div>
            ) : posts.length === 0 ? (
              <div className="post">
                <div className="post-content">
                  <div className="post-text">No posts found. Be the first to post!</div>
                </div>
              </div>
            ) : (
              posts.map(post => (
                <div key={post.id} className="post">
                  ...
                  <div className="post-content">
                        ...
                        <div className="poll-options">
                          {post.poll.options.map(option => (
                            <div key={option.id} className="poll-option">
                              ...
                              <span className="poll-votes">{option.vote_count} votes</span>
                            </div>
                          ))}
                        </div>
                    ...
                    <div className="post-actions">
                      ...
                      <div className="action-item" onClick={() => handleRetweet(post.id)}>
